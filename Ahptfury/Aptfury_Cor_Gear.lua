...
function user_setup()
  ...
  state.Weapons:options('None','Default','DualSavageWeapons','DualSavageWeaponsACC','DualLeadenRanged','DualLeadenRangedACC','DualLeadenMelee','DualLeadenMeleeACC','Aeolian','Evisceration','DualLastStand','DualLastStandACC','LastStand','SBLS','Armageddon','Ongo')
  ...
  set_lockstyle(1)
  ammostock = 98
  ammostock = {['Quelling Bolt'] = 50, ['Devastating Bullet'] = 50, ['Chrono Bullet'] = 250, ['Chrono Arrow'] = 50, ['Living Bullet'] = 50}
...
function init_gear_sets()
  ...
  sets.precast.CorsairShot.Damage = {ammo="Hauksbok Bullet",
    ...
    body="Lanun Frac +3",hands="Nyame Gauntlets",ring1="Dingir Ring", --Fenrir Ring +1
    back=gear.leaden_back,waist="Eschan Stone",legs="Nyame Flanchard",feet="Lanun Bottes +3"}
  ...
  sets.precast.WS['Savage Blade'] = {ammo=gear.WSbullet,
    ...
    back=gear.sb_back,waist="Sailfi Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
  ...
  sets.precast.WS['Aeolian Edge'] = {ammo="Hauksbok Bullet",
    ...
    back=gear.leaden_back,waist="Orpheus's Sash", legs="Nyame Flanchard",feet="Lanun Bottes +3"}
  ...
  sets.weapons.Ongo = {main={name="Rostam",bag="inventory"},sub="Nusku Shield",range="Death Penalty"}
  -- Engaged sets
