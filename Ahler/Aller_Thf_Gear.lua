...
function user_setup()
  ...
  state.Weapons:options('Aeneas','Evisceration','MagicWeapons','Savage','None')
  ...
  gear.sb_jse_back = {name="Toutatis's Cape", augments={'STR+20','Accuracy+20 Attack+20','STR+10','Weapon skill damage +10%',}}
...
function init_gear_sets()
  ...
  sets.precast.WS['Evisceration'] = {ammo="Yetshila +1",
    ...
    back=gear.evisceration_jse_back,waist="Fotia Belt",legs="Pill. Culottes +3",feet="Mummu Gamash. +2"}
  ...
  sets.precast.WS['Savage Blade'] = {ammo="Seeth. Bomblet +1",
    head="Nyame Helm",neck="Anu Torque",ear1="Moonshade Earring",ear2="Ishvara Earring",
    body="Nyame Mail",hands="Nyame Gauntlets",ring1="Epaminondas's Ring",ring2="Regal Ring",
    back=gear.sb_jse_back ,waist="Sailfi Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
