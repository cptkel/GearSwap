...
function init_gear_sets()
  ...
  sets.precast.WS['Savage Blade'] = {ammo="Seething Bomblet +1",
    ...
    back=gear.hybrid_jse_back,waist="Sailfi Belt +1",legs="Nyame Flanchard",feet="Nyame Sollerets"}
  ...
  sets.engaged.Acc.PDT = set_combine(sets.engaged.PDT,{ammo="Date Shuriken",ear1="Telos Earring",ear2="Cessance Earring",ring1="Chirich Ring +1",ring2="Chirich Ring +1",waist="Kentarch Belt +1"})
