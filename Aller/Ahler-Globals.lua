...
send_command('bind @q send ahptfury exec aeolian')
send_command('bind !r send ahptfury exec savage')
send_command('bind !q send ahptfury exec leadenranged')
send_command('bind ^q send ahptfury exec leadenmelee')
send_command('bind @r send ahptfury gs c toggle rnghelper')
send_command('bind !a send ahptfury atkwm slave on')
send_command('bind ^a atkwm master')
send_command('bind ^n send @all lua u attackwithme')
send_command('bind !n send @all lua l attackwithme')
send_command('bind !s send @all ffo stopall')
send_command('bind !f send @all ffo ahler')
send_command('bind ^s send @all sneak me')
send_command('bind ^i send @all invisible me')
